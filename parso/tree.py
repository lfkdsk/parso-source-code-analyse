...
# Node 或者 Leaf 的基类，这个名字起的不好，
# 基类不如叫 Node，Leaf 是子叶子，List 是列表
class NodeOrLeaf(object):
    """
    The base class for nodes and leaves.
    """
    __slots__ = ()
    type = None  # 这东西就是 grammar 文件里的 BNF Node 的名字
    '''
...
# 叶子节点 类似于 Token、字符串啊之类的没有子节点的代表类
...
# 代表类型的 Leaf 暂时不知道是什么。。有可能和 BNF 的类型
...
# 这个 Node 应该就是我说的 List 就是有可能有子类的节点
